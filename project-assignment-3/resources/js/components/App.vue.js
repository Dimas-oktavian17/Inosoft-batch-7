...
[RouterView,];
{
const __VLS_0 = ({} as 'RouterView' extends keyof typeof __VLS_ctx ? { 'RouterView': typeof __VLS_ctx.RouterView }: typeof __VLS_resolvedLocalAndGlobalComponents).RouterView;
...
setup() {
return {
RouterView: RouterView as typeof RouterView,
};
},
});
